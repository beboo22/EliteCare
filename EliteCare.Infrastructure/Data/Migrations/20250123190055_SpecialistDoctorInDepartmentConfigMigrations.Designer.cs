...
namespace EliteCare.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250123190055_SpecialistDoctorInDepartmentConfigMigrations")]
    partial class SpecialistDoctorInDepartmentConfigMigrations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EliteCare.Data.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("EliteCare.Data.Entities.Receptionist", "Receptionist")
                        .WithOne()
                        .HasForeignKey("EliteCare.Data.Entities.Appointment", "ReceptionistId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
